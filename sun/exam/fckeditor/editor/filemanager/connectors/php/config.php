...
#ppframe reconfig!
$base_config['editor_userfiles'] = $base_config['editor_userfiles'] ? $base_config['editor_userfiles'] : 'userfiles';
$Config['UserFilesPath'] = '/' . $base_config['editor_userfiles'] . '/';
...
#ppframe reconfig!
$Config['UserFilesAbsolutePath'] = FCK_ROOT . $base_config['editor_userfiles'] . '/';
#ppframe add config!
$Config['PPCms_http_root'] = ereg('/$',$base_config['exam_root']) ? substr($base_config['exam_root'],0,-1) : $base_config['exam_root'];
