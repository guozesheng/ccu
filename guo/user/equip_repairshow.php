...
if ($ac=='delete')
{
	...
	$asksql->SetQuery("SELECT * FROM  #@__repair_ask WHERE  `id` = '$_GET[id]' LIMIT 1");
	$asksql->Execute();
	...
	{
		$asksql->close();
		showmsg("该申请已被管理员同意！", 'equip_repairlist.php');
		exit();
	}
	
	
	$asksql->SetQuery("DELETE FROM `#@__repair_ask` WHERE `id` = '$_GET[id]' LIMIT 1");
	$asksql->Execute();
	$asksql->close();
	showmsg("该申请已取消！", 'equip_repairlist.php');
	exit();
}
else if ($ac == "show")
{
...
<table width="100%" border="0" id="table_style_all" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="2">
     <tr>
      <td><strong>&nbsp;仪器报废申请</strong>&nbsp;&nbsp;- <a href="equip_repairlist.php?action=seek">申请列表</a> | <a href="equip_repairlist.php">申请历史</a></td>
