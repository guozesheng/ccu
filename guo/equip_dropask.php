...
<table width="100%" border="0" id="table_style_all" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="2">
     <tr>
      <td><strong>&nbsp;仪器报废待批</strong>&nbsp;&nbsp;<a href="equip_dropask.php">刷新</a> | <a href="equip_droplist.php">报废列表</a></td>
     </tr>
     <tr>
      <td bgcolor="#FFFFFF">
	   <?php
	   ...
	   if ($_GET['action'] == "seek")
	   {
		   $csql->SetQuery("select * from #@__drop_ask ");
	   }
	   else 
	   {
		   $csql->SetQuery("select * from #@__drop_ask where  isallow != 1 ");
	   }
	   $csql->Execute();
