...
{
	$today=date("Y-m-d");
	$sql = "INSERT INTO `#@__drop_ask` (`id`, `basic_id`, `boss_id`, `askdate`, `isallow`, `allowdate`, `allow_id`, `comment`) VALUES (NULL, '$id', '$_SESSION[boss]', '$today', '', '', '', '$cp_bz');";
...
<table width="100%" border="0" id="table_style_all" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="2">
     ...
     </tr><form action="equip_drop.php?action=save" method="post" name="form1">
     <tr>
      <td bgcolor="#FFFFFF">
