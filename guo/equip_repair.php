...
<table width="100%" border="0" id="table_style_all" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="2">
     <tr>
      <td><strong>&nbsp;仪器维修</strong>&nbsp;&nbsp;<a href="equip_repair.php">刷新</a> | <a href="equip_repair.php?action=seek">申请列表</a></td>
     </tr>
     <tr>
      <td bgcolor="#FFFFFF">
	   <?php
	   ...
	   ?>
       	<tr class='row_content'>
        	...
        	<td>&nbsp;<?=$bossrow['name']?></td>
        	<td>&nbsp;<?=$row['askdate']?></td>
            <td>&nbsp;<?php if ($row['isallow'] == 0) echo "未批准"; else if ($row['isallow'] == 1) echo "<font color=\"#0000FF\">已维修</font>"; else if ($row['isallow'] == 2) echo "<font color=\"#FF0000\">已拒绝</font>"; ?></td>
            <td>&nbsp;
            <?php
				if ($row['allowdate'] != 0)
				{
