	...
	<table width="100%" border="0" cellpadding="0" cellspacing="2">
     ...
     <tr>
	  ...
	  <?php if($action=='new'){ ?>
	   ...
	   echo "<tr class='row_color_gray'><td>".$row['id']."</td><td><img src=images/cate.gif align=absmiddle>&nbsp;".$row['dwname']."</td><td><a href=system_dw_edit.php?id=".$row['id'].">修改</a> | <a href=system_dw_del.php?id=".$row['id'].">删除</a></td></tr>";
